...
syn keyword cmakeKWfind_program
            \ CMAKE_FIND_ROOT_PATH_BOTH DOC DVAR HINTS NAMES NAMES_PER_DIR NOTFOUND NO_ NO_CMAKE_ENVIRONMENT_PATH NO_CMAKE_FIND_ROOT_PATH NO_CMAKE_PATH NO_CMAKE_SYSTEM_PATH NO_DEFAULT_PATH NO_SYSTEM_ENVIRONMENT_PATH ONLY_CMAKE_FIND_ROOT_PATH OS PATH PATHS PATH_SUFFIXES VAR
            \ contained
...
syn keyword cmakeKWget_property
            \ BRIEF_DOCS CACHE DEFINED DIRECTORY FULL_DOCS GLOBAL INSTALL NOTFOUND PROPERTY SET SOURCE TARGET TEST VARIABLE
            \ contained

syn keyword cmakeKWget_source_file_property
            \ LOCATION NOTFOUND VAR
            \ contained
...
syn keyword cmakeKWif
            \ AND ARGS CMP COMMAND DEFINED EQUAL EXISTS FALSE GREATER IGNORE IN_LIST IS_ABSOLUTE IS_DIRECTORY IS_NEWER_THAN IS_SYMLINK LESS MATCHES NNNN NO NOT NOTFOUND OFF ON OR POLICY STREQUAL STRGREATER STRLESS TARGET TEST THEN TRUE VERSION_EQUAL VERSION_GREATER VERSION_LESS YES
            \ contained

syn keyword cmakeKWinclude
            \ NOTFOUND NO_POLICY_SCOPE OPTIONAL RESULT_VARIABLE VAR
            \ contained
...
syn keyword cmakeKWvariable_requires
            \ NOTFOUND RESULT_VARIABLE TEST_VARIABLE
            \ contained
